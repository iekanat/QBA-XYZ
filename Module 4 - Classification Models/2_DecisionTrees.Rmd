...
We will be using the EPA vehicle data for this exercise. The data can be found in [EPA datasets online](https://www.fueleconomy.gov/feg/download.shtml). I downloaded the data in first quarter of 2018. They may have updated the dataset since then. I have taken the liberty of reducing the number of variables and observations. So if you independently download the dataset you might find more variables.
